...
public class FieldDrive extends CommandOpMode {
    ...
    public void initialize(){
        ...
        final.IMU.Parameters = new IMU.Parameters(
    ...
    public void run(){
        if (!Utils.isWithinTolerance(0, gamepad1Ex.getLeftX(), 0.1)
                && !Utils.isWithinTolerance(0,gamepad1Ex.getLeftY(), 0.1)
                && !Utils.isWithinTolerance(0, gamepad1Ex.getRightX(), 0.1)){
